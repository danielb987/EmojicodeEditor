 ...
 * The preferred size of the container assumes all components will be laid
 * out in a single row. The layout code will wrap components to the next
 * row when the maximum width of the container is encountered. However,
 * the problem is that the functions don’t talk to one another. When the
 * components are wrapped to a new row, the preferred size doesn’t change
 * so you never see the components on the extra row.
 */
...
public class WrapLayout extends FlowLayout {
    ...
    */
    public WrapLayout() {
        super(java.awt.FlowLayout.LEFT);
    }
    ...
    */
    private Dimension layoutSize(final Container target,
        ...
        synchronized (target.getTreeLock()) {
            ...
            // containter.When the container width = 0, the preferred
            // width of the container has not yet been calculated so
            // lets ask for the maximum.
